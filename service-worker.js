...
const CORE_ASSETS = [
  ...
  "/Assets/Icons/icon-164.png",
  "/Assets/Icons/icon-220.png",
  "/Assets/Icons/icon-320.png",

  "/Assets/Logoes/Logo.png",
  "/Assets/Logoes/icon-384.png",
  "/Assets/Logoes/icon-512.png",
  "/Assets/Logoes/icon-16.png",
  "/Assets/Logoes/icon-32.png",
  "/Assets/Logoes/icon-48.png",
  "/Assets/Logoes/icon-96.png",
  "/Assets/Logoes/icon-128.png",
